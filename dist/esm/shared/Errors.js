...
import { inherits as _inherits, createSuper as _createSuper, wrapNativeSuper as _wrapNativeSuper, classCallCheck as _classCallCheck } from '../_virtual/_rollupPluginBabelHelpers.js';

var DiagramSchemaError = function (_Error) {
  _inherits(DiagramSchemaError, _Error);

  var _super = _createSuper(DiagramSchemaError);

  function DiagramSchemaError() {
    var _this;

    _classCallCheck(this, DiagramSchemaError);
